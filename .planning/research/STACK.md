...
```bash
# Core
npm install express@5.2.1 pg@8.20.0 dotenv@17.4.0

# Authentication
npm install jsonwebtoken@9.x bcrypt@6.0.0 passport@0.7.x passport-jwt@4.0.1 passport-google-oauth20@2.0.0

# HTTP & Routing
npm install axios@1.7.x

# Utilities
npm install uuid@9.x

# Dev
npm install -D typescript@5.6 jest@30.3.0 supertest@7.x @types/node @types/express
```
...
```bash
# Core
npm install react@19.2.1 react-dom@19.2.1 react-router@7.x

# Forms & State
npm install react-hook-form@7.x zustand@4.x

# Maps
npm install leaflet@1.9.x react-leaflet@5.0.0

# Styling
npm install -D tailwindcss@4.x postcss autoprefixer
npm install @shadcn/ui (optional, copy-paste components)

# Dev
npm install -D vite@6.x @vitejs/plugin-react typescript@5.6 tailwindcss @tailwindcss/vite
npm install -D @testing-library/react@16.x jest@30.3.0 @testing-library/jest-dom
```
...
services:
  ...
  backend:
    ...
    environment:
      DATABASE_URL: postgresql://postgres:${DB_PASSWORD}@postgres:5432/roadtrip
